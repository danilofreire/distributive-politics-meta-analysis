...
dat %>%
  ...
  mutate(depvar2 = factor(depvar2,
                          labels = c("Per Capita Expenditure",
                                     "Percentage GDP Public Expenditure",
...
f2 <- build_forest(mod, NULL, 15, ttl = 'Upper Chamber Size\nand Expenditure Per Capita')
```
...
f3 <- build_forest(mod, NULL, 15, ttl = 'Lower Chamber Size\nand Log Expenditure Per Capita')
```
...
```{r,include=F, echo = FALSE, warning=F, cache=TRUE}
f4  <- build_forest(mod, NULL, 15, ttl = 'Log of Lower Chamber Size\nand Log of Expenditure Per Capita')
```
...
f5 <- build_forest(mod, NULL, 15, ttl = 'Lower Chamber Size\nand Expenditure as Percentage of GDP')
```
...
This model investigates the percentage of GDP as public expenditure as the dependent variable and the log lower house size as the treatment variable.
...
```{r, include=F, warning=F, cache=TRUE, echo = FALSE}
f6 <- build_forest(mod, NULL, 15, ttl = 'Log Lower Chamber Size\nand Expenditure as Percentage of GDP')
```
...
```{r, include=F, warning=F, cache=TRUE, echo = FALSE}
f7 <- build_forest(mod, NULL, 15, ttl = 'Upper Chamber Size\nand Expenditure as Percentage of GDP')
```
...
f9 <- build_forest(mod, capt = NULL, 
                       lsize = 15, ttl = 'Lower Chamber Size and Log of Expenditure per Capita\n(subgrouping by RDD)')
```
