...
The *law of 1/n* was conceived to explain the expected relationship that XXXX when increasing the chamber size. However, papers such as @chen2007law demonstrated that the relationship is mediated by the size of the upper chamber. Their finding suggests that the institutional design of the legislature influences the empirical predictions in the sample we study. To test this possibility, we estimated a subgroup analysis using a binary indicator for institutional design. The results may be seen below.
